...
<!-- style="background-image: url('flag.jpg'); background-color: #F1E9D2;" -->
<!-- style="background-color: #F1E9D2 " -->
  <!-- Content Wrapper. Contains page content -->
  <!-- <div class="content-wrapper" style="background: linear-gradient(135deg, #FF9933, #FFFFFF, #138808); color: black; font-family: Times;">
 -->
  <!-- <div class="content-wrapper" style="background-color: #F1E9D2 " > -->
  <div class="content-wrapper" style="background: linear-gradient(135deg, #FF9933, #FFFFFF, #138808);">
    ...
    <section class="content">
      ...
      <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <!-- style="background-color:#B0C4DE ;color:black ; font-size:15px;" -->
            <div class="inner" style="background: linear-gradient(135deg, #FF9933, #FFFFFF, #138808); font-size:15px; color:black ; " >
              <?php
        ...
        <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="small-box bg-green">
            <!-- style="background-color: 	#DEB887 ;color:black ; font-size:15px" -->
        ...
        <div class="col-lg-3 col-xs-6" style="color:black ; font-size: 15px; font-family:Times">
          ...
          <!-- style="background-color: #778899 ;color:black ; font-size:15px; font-family:Times" -->
          <div class="inner" style="background: linear-gradient(135deg, #FF9933, #FFFFFF, #138808); font-size:15px; color:black ; " >
              <?php
            ...
            <div class="icon">
              ...
              <!-- style="background-color: #2F4F4F ;color:black ; font-size: 18px" -->
            </div>
